...
// .wrangler/tmp/bundle-T91kFZ/checked-fetch.js
...
// src/lib/adobe-client.ts
var LightroomClient = class {
  config;
  ...
  async getAssetRendition(assetId) {
    return this.fetch(`/catalog/assets/${assetId}/renditions/2048`);
  }
};
__name(LightroomClient, "LightroomClient");
...
// .wrangler/tmp/bundle-T91kFZ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-T91kFZ/middleware-loader.entry.ts
